...
uint32_t ids[6] = {RESOURCE_ID_ONE_PICTURE, RESOURCE_ID_TWO_PICTURE, RESOURCE_ID_THREE_PICTURE, RESOURCE_ID_FOUR_PICTURE, RESOURCE_ID_FIVE_PICTURE, RESOURCE_ID_SIX_PICTURE};
